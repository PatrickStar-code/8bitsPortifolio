...
export default function Gameboy() {
  ...
  return (
    <div className="bg-gameboy w-[35rem] h-[50rem]   border-4 rounded-br-[10rem] flex bg-[#B6B5B3] rounded-t-2xl rounded-bl-2xl  items-center flex-col">
      {/* Tela */}
      <div className="gameboy-screen-mockup relative  w-[80%]  h-[40%] border-[#565763] bg-[#565763]  border-4 mt-20  flex flex-col p-2  rounded-t-2xl rounded-bl-2xl rounded-br-4xl retro  text-xs">
        ...
        <div className=" absolute  top-1/2 flex flex-col items-center ml-2 gap-2">
          <div className="pin w-3 h-3  bg-[#291920] rounded-full"></div>
          <p className="text-[0.5rem] text-white ">Battery</p>
        </div>
        <div className="absolute top-1/2 left-1/2 w-[60%] h-[80%]  transform -translate-x-1/2 -translate-y-1/2 bg-[#465716] rounded-md"></div>
      </div>
      {/* Fim Tela */}
      ...
      <div className="button-container relative left-[5rem] top-[7rem]">
        <div className="A-Container">
          <button className="button absolute bg-[#7D0A45]  hover:bg-[#620835] rounded-full w-15 h-15   " />
      ...
      <div className="button-container relative -left-2 top-[16rem] flex gap-4">
        ...
        <div className=" transform -rotate-[20deg] text-black retro">
          <div>
            <button className="bg-[#6D6B76] hover:bg-[#5F5E65] rounded-full w-18 h-4"></button>{" "}
          </div>
