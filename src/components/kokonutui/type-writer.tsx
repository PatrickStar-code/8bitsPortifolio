...
export default function TypewriterTitle({
  sequences = [
    { text: "Programmer", deleteAfter: true },
    { text: "FullStack", deleteAfter: true },
    { text: "Java and Javascript", deleteAfter: false },
  ],
  typingSpeed = 200,
  startDelay = 500,
  autoLoop = true,
  ...
  return (
    ...
    >
      <motion.div
        className="text-4xl font-mono text-cyan-700 tracking-tight flex items-center gap-2"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      >
        <span
